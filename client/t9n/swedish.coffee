sv =
  ...
  emailResetLink: "Skicka återställningslänk"
  ...
  verificationPending: "Bekräfta din e-postadress"
  verificationPendingDetails: "Ett aktiveringsmeddelande har skickats till den e-postadress du angav. Klicka på bekräftelselänken för att aktivera ditt konto."
  and: "och"
